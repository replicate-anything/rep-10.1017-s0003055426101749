...
**Pattern B (baked under `outputs/`, not this cache):**

| Step | Dataverse file(s) | Baked sink |
|------|-------------------|------------|
| `access_fig_2_data` | [13684074](https://dataverse.harvard.edu/api/access/datafile/13684074?format=original) | `outputs/10fold_training_results.csv` |
| `access_fig_5_data` | 13684105, 13684086, 13684076, 13684101 | `outputs/{attractiveness,trustworthiness,competence,aggressiveness}.csv` |
